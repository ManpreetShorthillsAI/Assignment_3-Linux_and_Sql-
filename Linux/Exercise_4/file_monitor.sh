...
MONITOR_DIR="/home/shtlp_0057/Desktop/monitor"
...
upload_to_database() {
    ...
    echo "DEBUG: file_name=$file_name, file_size=$file_size, timestamp=$timestamp"
    ...
    if [[ "$duplicate" -eq 0 ]]; then
        ...
        mysql -u $DB_USER -p$DB_PASS -D $DB_NAME -e "INSERT INTO files (file_name, file_size, timestamp) VALUES ('$file_name', $file_size, '$timestamp');" 2>> $LOG_FILE
